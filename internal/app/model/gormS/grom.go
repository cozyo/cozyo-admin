...
import (
	"github.com/cozyo/internal/app/model/gormS/entity"
	"strings"
	"time"

	"github.com/cozyo/internal/app/conf"
	//"github.com/cozyo/internal/app/model/gormx/entity"
...
func AutoMigrate(db *gorm.DB) error {
	if dbType := conf.C.Gorm.DBType; strings.ToLower(dbType) == "mysql" {
		db = db.Set("gorm:table_options", "ENGINE=InnoDB")
	}

	return db.AutoMigrate(
		new(entity.AdminUser),
	).Error
}
